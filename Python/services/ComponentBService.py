...
class ComponentBService():
    ...
    def do_it(self):
        self._logger.log_information(f"ComponentBService (TransientState): {self._transient_state.get_value()}")
        self._logger.log_information(f"ComponentBService (SingletonState): {self._singleton_state.get_value()}")
